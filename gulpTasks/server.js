...
gulp.task('watch', function() {
    watch('angular1/app/**/*.html', () => gulp.start('app.html')); //se houver alterações html
    //chame somente o app.html
    watch('angular1/app/**/*.css', () => gulp.start('app.css')); //se houver alterações CSS
    //chame somente o app.css
    watch('angular1/app/**/*.js', () => gulp.start('app.js')); //se houver alterações JS
